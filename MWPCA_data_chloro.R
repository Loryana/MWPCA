...
setwd("~/Thèse/Script/Groupes AB chloro") #pour l'enregistrement des figures
...
for(g in 1:length(genotyp)){
  ...
  for(h in 2:8){
    ...
    setwd("~/Thèse/Script/Groupes AB chloro/MWPCA")
    ...
    setwd("~/Thèse/Script/Groupes AB chloro")
...
setwd("~/Thèse/Script/Groupes AB chloro/Résultat")
